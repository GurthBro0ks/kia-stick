...
export function inspectLocalProof(proofPath) {
  ...
  const commit = fieldValue(resultMarkdown, "COMMIT_SHA") || fieldValue(resultMarkdown, "Commit SHA") || fieldValue(resultMarkdown, "TERMINAL_CLOSEOUT_COMMIT_SHA") || fieldValue(resultMarkdown, "CLOSEOUT_COMMIT_SHA") || "";
