...
describe("v0.7.19 bundled operator QA pack", () => {
  ...
  it("keeps feature and queue state pending operator bundle review", () => {
    ...
    expect(featureList.v0719_bundled_operator_qa_pack.status).toBe("ready_for_operator_bundle_review");
    expect(featureList.v0719_bundled_operator_qa_pack.queue_015_status).toBe("blocked");
    expect(featureList.v0719_bundled_operator_qa_pack.queue_034_status).toBe("needs_review");
    expect(featureList.v0719_bundled_operator_qa_pack.manual_qa_status).toBe("pending_operator_bundle_review");
    ...
    expect(q034?.status).toBe("needs_review");
