...
describe("public Settings summary and operator diagnostics split", () => {
  ...
  it("renders the complete existing governance ledger only when diagnostics are opened", () => {
    ...
    expect(html).toContain("Current working bundle</dt><dd>Accessibility and Saved-State Resilience Post-Push Accepted-State Refresh; validation PASS; pushed no; manual QA pending operator review");
