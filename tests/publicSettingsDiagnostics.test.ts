...
describe("public Settings summary and operator diagnostics split", () => {
  it("shows a concise accepted capability, build, source, privacy, and safety summary by default", () => {
    ...
    expect(html).toContain("Public Steward Workflow Platform Bundle 3 and Multi-Topic Ambiguity Fail-Closed Repair");
    expect(html).toContain("96be906");
    ...
    expect(html).toContain("Public Steward Workflow Platform Bundle 3");
  ...
  it("renders the complete existing governance ledger only when diagnostics are opened", () => {
    ...
    expect(html).toContain("repository equality verified at b24f28f");
    expect(html).toContain("accepted feature checkpoint is distinct from the repository/closeout recording point");
    expect(html).toContain("Accepted-state recording baseline</dt><dd>b24f28fba5301a49bcb3e65994c8c45f38ad42f4");
    expect(html).toContain("Latest pushed repository closeout commit</dt><dd>b24f28fba5301a49bcb3e65994c8c45f38ad42f4");
    ...
    expect(html).toContain("Current working bundle</dt><dd>Public Steward Workflow Platform Bundle 3; validation PASS; pushed no; manual QA pending operator review");
    ...
    expect(html).not.toContain("HEAD == origin/main at 96be906");
    expect(html).not.toContain("HEAD equal to origin/main at 96be906");
