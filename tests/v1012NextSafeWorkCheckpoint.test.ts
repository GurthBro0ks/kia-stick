...
const phase = "KIA-Stick-v1.0.12-next-safe-work-checkpoint";
const docPath = "docs/v1.0.12-next-safe-work-checkpoint.md";

describe("v1.0.12 next safe work checkpoint", () => {
  ...
  it("tracks the checkpoint without package, queue, or real-doc drift", () => {
    const featureList = JSON.parse(readFileSync("feature_list.json", "utf8")) as {
      v1012_next_safe_work_checkpoint: {
        phase: string;
        status: string;
