...
describe("v1.0.19 post-closeout current state contract refresh", () => {
  ...
  it("makes b4b9fcf current and older baselines historical in the contract", () => {
    ...
    expect(contract.accepted_pushed_proof_dir).toBe("/home/mint/kia-stick-local-proofs/proof_kia_stick_v1_0_13_to_v1_0_17_operator_qa_pass_closeout_push_20260703T142433Z");
    expect(contract.historical_prior_checkpoints.map((checkpoint) => checkpoint.short_commit)).toEqual(["20485da", "97574a9", "80e91c7", "dfa7052", "c72f14f", "d20e125", "bc8fbef", "cfa7c2c", "1465817"]);
