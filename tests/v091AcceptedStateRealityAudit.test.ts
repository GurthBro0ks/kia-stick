...
describe("v0.9.1 accepted-state reality audit", () => {
  ...
  it("tracks current feature and queue state without approving real-doc work", () => {
    ...
    expect(featureList.v091_accepted_state_reality_audit.status).toBe("pending_operator_bundle_review");
    expect(featureList.v091_accepted_state_reality_audit.queue_046_status).toBe("needs_review");
