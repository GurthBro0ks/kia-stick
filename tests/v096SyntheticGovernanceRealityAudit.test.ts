...
describe("v0.9.6 synthetic governance reality audit", () => {
  ...
  it("tracks current bundle state without approving real-doc work", () => {
    ...
    expect(featureList.v096_synthetic_governance_reality_audit.status).toBe("accepted_after_closeout_push");
    expect(featureList.v096_synthetic_governance_reality_audit.queue_051_status).toBe("accepted");
