...
describe("v0.9.6 synthetic governance reality audit", () => {
  ...
  it("tracks current bundle state without approving real-doc work", () => {
    ...
    expect(featureList.v096_synthetic_governance_reality_audit.status).toBe("operator_qa_pass_ready_for_closeout");
    expect(featureList.v096_synthetic_governance_reality_audit.queue_051_status).toBe("ready_to_push");
