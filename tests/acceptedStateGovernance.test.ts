...
describe("accepted-state governance loop break", () => {
  it("records pushed Bundle 1 as current while retaining annual leave as history", () => {
    ...
    expect(currentAcceptedPushedState.accepted_bundle).toBe("KIA-Stick-public-steward-workflow-platform-bundle-1");
    expect(currentAcceptedPushedState.accepted_pushed_commit).toBe("ea0ce8de9cd6b85b56528fabc9e8ca7f8bf43a52");
    expect(currentAcceptedPushedState.accepted_pushed_short_commit).toBe("ea0ce8d");
    expect(currentAcceptedPushedState.repository_recording_commit).toBe("24abecd2ba6a7018e5eb58b113e99ad90196eb07");
    expect(currentAcceptedPushedState.repository_recording_short_commit).toBe("24abecd");
    expect(currentAcceptedPushedState.accepted_equality).toContain("HEAD == origin/main == remote main == 24abecd2ba6a7018e5eb58b113e99ad90196eb07");
    expect(currentAcceptedPushedState.accepted_equality).not.toContain("HEAD == origin/main == remote main == ea0ce8de");
    expect(currentAcceptedPushedState.accepted_pushed_proof_dir).toContain("closeout_push_20260725T105111Z");
    ...
    expect(currentAcceptedPushedState.latest_pushed_closeout_status).toContain("repository equality at 24abecd2ba6a7018e5eb58b113e99ad90196eb07");
    ...
    expect([
      ...
      "ea0ce8de9cd6b85b56528fabc9e8ca7f8bf43a52",
      "24abecd2ba6a7018e5eb58b113e99ad90196eb07",
      "24abecd2ba6a7018e5eb58b113e99ad90196eb07",
    ]);
    expect(new Set([
      currentAcceptedPushedState.accepted_pushed_commit,
