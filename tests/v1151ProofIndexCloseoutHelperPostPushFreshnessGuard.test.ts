...
describe("v1.1.51 helper and proof-index freshness", () => {
  it("reports b8fb834 and rejects historical predecessors as current", () => {
    ...
    for (const historical of ["0286f03", "ac23ed9", "05cb559", "a215dd4", "0051a15"]) {
