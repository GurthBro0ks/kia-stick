...
const phase = "KIA-Stick-v0.9.77-next-large-work-checkpoint";
const docPath = "docs/v0.9.77-next-large-work-checkpoint.md";

describe("v0.9.77 next large-work checkpoint", () => {
  it("records next choices after proof-root freshness work", () => {
  ...
  it("tracks the checkpoint without package, queue, or real-doc drift", () => {
    ...
    const state = featureList.v0977_next_large_work_checkpoint;
