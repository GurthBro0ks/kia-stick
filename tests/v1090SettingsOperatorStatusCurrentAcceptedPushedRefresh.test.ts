...
describe("v1.0.90 Settings operator-status current accepted pushed refresh", () => {
  ...
  it("uses the shared contract in runtime Settings and keeps stale current labels out", () => {
    ...
    expect(component).toContain("Older baselines, including fcf5097, 6ca589d, f662b37, cf2be1f, d099ff5, 73b3f38, 5b7a575, 720a58a, 5c7f360, 886631f, 841dee7, 870d3a7, 87420e2, 8b42744, b4b9fcf, 20485da, 97574a9, 80e91c7, dfa7052, c72f14f, d20e125, bc8fbef, cfa7c2c, and 1465817, are historical only and not current.");
