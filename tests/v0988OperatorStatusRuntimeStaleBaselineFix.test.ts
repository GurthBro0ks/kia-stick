...
describe("v0.9.83 to v0.9.87 operator-status runtime stale-baseline fix", () => {
  ...
  it("surfaces the post-v0.9.92 c72f14f baseline in runtime Settings and keeps older baselines historical", () => {
    ...
    expect(contract).toContain("/home/mint/kia-stick-local-proofs/proof_kia_stick_v1_0_98_to_v1_1_2_post_closeout_accepted_state_contract_refresh_20260709T110558Z/closeout_push_20260709T120853Z");
    expect(contract).toContain('"accepted_pushed_short_commit": "6d0715b"');
