...
const currentLocalPhase = "KIA-Stick-bundle-3-core-repair-QA-runtime-truth-and-favicon-fix";
const acceptedCommit = "96be9069e7694af237823b0da3a30919be60546c";
...
describe("Bundle 3 QA runtime truth and favicon correction", () => {
  it("separates the accepted checkpoint from the operator-approved current local build", async () => {
    ...
    expect(html).toContain("Feature commit</dt><dd>96be906");
