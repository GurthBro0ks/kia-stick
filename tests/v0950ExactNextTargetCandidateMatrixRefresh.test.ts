...
const phase = "KIA-Stick-v0.9.50-exact-next-target-candidate-matrix-refresh";
const docPath = "docs/v0.9.50-exact-next-target-candidate-matrix-refresh.md";

describe("v0.9.50 exact Next target candidate matrix refresh", () => {
  ...
  it("tracks unclear target status and blocked implementation state", () => {
    ...
    const state = featureList.v0950_exact_next_target_candidate_matrix_refresh;
