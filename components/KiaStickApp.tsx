...
const acceptedOperatorCheckpoint = [
  ...
  { label: "This local bundle", value: "v1.0.88-to-v1.0.92 post-closeout accepted-state contract refresh; validation PASS pending; pushed no; manual QA pending" },
