...
const acceptedOperatorCheckpoint = [
  ...
  { label: "This local bundle", value: "v1.0.3-to-v1.0.7 post-closeout accepted-state contract refresh; validation PASS; pushed no" },
        ...
        {tab === "settings" && (
          <section className="tabPanel settingsPanel">
            ...
            <section className="aboutPanel" aria-label="Fake-only operator status">
              ...
              <p>
                Current accepted pushed state is {currentAcceptedPushedState.checkpoint} at {currentAcceptedPushedState.accepted_pushed_commit} with validation {currentAcceptedPushedState.accepted_validation}, manual QA {currentAcceptedPushedState.accepted_manual_qa}, push yes, and HEAD equal to origin/main at {currentAcceptedPushedState.accepted_pushed_short_commit}. Older baselines, including 80e91c7, dfa7052, c72f14f, d20e125, bc8fbef, cfa7c2c, and 1465817, are historical only and not current. Historical accepted-WARN state is parked, not current. This status block is copy-only; Next/PostCSS remains WARN_SAFE_NEXT_TARGET_UNCLEAR, v0.9.12C remains blocked, queue-015 remains blocked, package lock is unchanged, and no real-doc capability is approved.
              </p>
