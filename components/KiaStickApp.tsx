...
const acceptedOperatorCheckpoint = [
  ...
  { label: "This local bundle", value: "v1.0.98-to-v1.1.2 post-closeout accepted-state contract refresh; validation PASS pending; pushed no; manual QA pending" },
