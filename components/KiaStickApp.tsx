...
const acceptedOperatorCheckpoint = [
  ...
  { label: "This local bundle", value: "v1.1.3-to-v1.1.7 post-closeout accepted-state contract refresh; validation PASS pending; pushed no; manual QA pending" },
